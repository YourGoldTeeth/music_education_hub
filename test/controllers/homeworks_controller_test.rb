...
class HomeworksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create homework" do
    assert_difference('Homework.count') do
      post homeworks_url, params: { homework: { assignment_id: @homework.assignment_id, name: @homework.name, user_id: @homework.user_id } }
    end
  ...
  test "should update homework" do
    patch homework_url(@homework), params: { homework: { assignment_id: @homework.assignment_id, name: @homework.name, user_id: @homework.user_id } }
